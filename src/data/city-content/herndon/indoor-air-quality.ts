...
export const content: CityServiceContent = {
  ...
  pricingSection: {
    ...
    factors: [
      'Property type—residential home, townhome, commercial office, or critical facility have different assessment protocols',
