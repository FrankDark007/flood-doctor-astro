...
export const content: CityServiceContent = {
  ...
  introSection: {
    ...
    localContext: `Great Falls custom estates feature multi-zone HVAC, climate-controlled specialty rooms, equestrian and auxiliary structures, and premium finishes that create IAQ assessment environments requiring instrumentation and experience beyond standard residential testing.`,
  },
  processSteps: [
    {
