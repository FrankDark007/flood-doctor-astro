    ...
    equipment: [
      {
        ...
        purpose: 'Remove hundreds of gallons of standing water per hour from flooded Vienna homes. Truck-mounted systems generate significantly more suction than portable units, extracting water from carpet, hardwood, tile, and concrete surfaces faster and more completely than any consumer equipment.',
        brand: 'Prochem',
      },
      {
        name: 'LGR Commercial Dehumidifiers',
        purpose: 'Low-grain refrigerant dehumidifiers remove 15 to 30 gallons of moisture per day from affected spaces. Multiple units operate simultaneously across all affected rooms, maintaining relative humidity below 40% to drive moisture out of structural materials and prevent secondary mold growth during the drying period.',
        brand: 'Dri-Eaz',
      },
      {
        name: 'Thermal Imaging Cameras',
        purpose: 'Detect hidden moisture behind walls, above ceilings, and beneath floors without destructive investigation. Temperature differentials between wet and dry materials appear clearly on thermal displays, allowing technicians to trace water migration paths through Vienna colonials and identify every affected area for targeted drying.',
        brand: 'FLIR',
      },
      {
        name: 'Injectidry Wall Drying Systems',
        purpose: `Force dry air into wall cavities through small ports without removing plaster, lath, or trim. Pressurized air circulates behind wall surfaces, evaporating trapped moisture that conventional air movers cannot reach. This system is critical for preserving Vienna's original plaster walls during burst pipe restoration.`,
        brand: 'Injectidry',
      },
      {
        name: 'Hardwood Floor Drying Mats',
        purpose: 'Apply controlled negative pressure across hardwood floor surfaces, drawing moisture upward through the wood grain at rates the cellular structure can tolerate. Prevents cupping, crowning, and permanent warping that occurs when hardwood is dried too aggressively or left wet too long. Each mat covers approximately 60 square feet.',
        brand: 'Dri-Eaz',
      },
      {
        name: 'Penetrating Moisture Meters',
        purpose: 'Measure moisture content inside wood framing, subfloor sheathing, and wall studs using pin-type probes that penetrate material surfaces. Readings are logged daily at dozens of documented points throughout the affected area, creating drying curves that verify when materials reach manufacturer-specified safe moisture levels for reconstruction.',
        brand: 'Delmhorst',
      },
      {
        name: 'Air Scrubbers with HEPA Filtration',
        purpose: 'Filter airborne particulates including mold spores, dust from demolition activities, and construction debris during restoration. HEPA filters capture 99.97% of particles down to 0.3 microns, maintaining safe indoor air quality throughout the drying and reconstruction phases.',
        brand: 'Dri-Eaz',
      },
      {
        name: 'Submersible Extraction Pumps',
        purpose: 'Remove deep standing water from flooded basements before truck-mounted extraction can begin. Submersible pumps handle 2 to 6 inches of standing water on basement floors, clearing volume rapidly so structural drying equipment can be deployed without delay. Essential for hot water heater failures and major supply line bursts.',
        brand: 'Prochem',
      },
    ],
    localNote: `Vienna's 1950s-70s colonials require equipment specifically suited for plaster wall preservation and hardwood floor protection. Our Injectidry wall systems and Dri-Eaz floor mats are deployed on virtually every Vienna burst pipe job because aggressive drying methods designed for modern construction damage these original materials. Every technician on our Vienna crews is trained in low-velocity plaster drying and controlled hardwood moisture extraction.`,
  },
  pricingSection: {
    headline: 'Burst Pipe Restoration Pricing',
    intro: 'Every burst pipe scenario is different. A pinhole leak behind a bathroom wall involves far less restoration than a catastrophic galvanized pipe failure flooding two stories. We provide detailed written estimates after on-site assessment, and most Vienna homeowners insurance policies cover sudden burst pipe damage in full. Our team works directly with your insurance adjuster to document damage, justify costs, and maximize your claim.',
    factors: [
