...
export const content: CityServiceContent = {
    ...
    equipment: [
      {
        ...
        purpose: 'Removes hundreds of gallons of standing water per minute from flooded basements and lower levels, powered directly from our service vehicle for unlimited runtime during extended extraction operations.',
        brand: 'Prochem',
      },
      {
        name: 'Low-Grain Refrigerant Dehumidifiers',
        purpose: 'Pulls moisture from saturated air at the molecular level, achieving grain depression levels that standard dehumidifiers cannot reach. Critical for drying plaster walls and hardwood floors in Vienna homes without creating conditions that cause cracking or excessive shrinkage.',
        brand: 'Dri-Eaz',
      },
      {
        name: 'Thermal Imaging Cameras',
        purpose: 'Detects hidden moisture behind walls, above ceilings, and under floors by identifying temperature differentials invisible to the naked eye. Essential for mapping the full extent of water migration in Vienna colonials where water travels along plaster lath and balloon-frame cavities far from the original source.',
        brand: 'FLIR',
      },
      {
        name: 'Wall Cavity Drying System',
        purpose: `Delivers warm, dry air directly into wall cavities through small, discreet panel ports — drying plaster and lath walls from the inside out without the aggressive open-air exposure that causes historic plaster to crack, delaminate, and fail. This system is our primary tool for preserving the plaster walls in Vienna's older homes.`,
        brand: 'Injectidry',
      },
      {
        name: 'Hydroxyl Generators',
        purpose: 'Neutralizes odors at the molecular level using hydroxyl radical technology — safely eliminating musty water damage smells without ozone, which can damage rubber seals, artwork, and electronics. Safe to operate in occupied spaces during the drying process.',
        brand: 'Vaportek',
      },
      {
        name: 'Axial Air Movers',
        purpose: 'High-velocity airflow across wet surfaces accelerates evaporation from carpet, hardwood, drywall, and concrete. Strategically positioned based on psychrometric calculations to create optimal drying conditions across the affected footprint. We deploy 10 to 30 units depending on the scope of damage.',
      },
      {
        name: 'Hardwood Floor Drying Mats',
        purpose: `Specialty vacuum-and-heat mat system that draws moisture upward through hardwood planks, reversing early-stage cupping and preventing permanent damage to Vienna's valuable original oak floors. This targeted approach saves floors that would otherwise require full replacement.`,
      },
      {
        name: 'HEPA Air Scrubbers',
        purpose: 'Filters airborne particulates, mold spores, and contaminants from the indoor environment during restoration. Creates negative air pressure in contained work areas to prevent cross-contamination to unaffected rooms.',
      },
      {
        name: 'Moisture Detection Instruments',
        purpose: 'Pin-type and pinless moisture meters, thermo-hygrometers, and data loggers providing precise measurement of moisture content in wood, drywall, plaster, concrete, and ambient air. These readings drive every drying decision and document progress for insurance.',
        brand: 'Delmhorst / Tramex',
      },
    ],
    localNote: `Our equipment inventory is specifically curated for the restoration challenges we encounter most frequently in Vienna: Injectidry systems for the community's abundant plaster-wall colonials, hardwood drying mats for preserving original oak floors, and oversized dehumidification capacity for the large finished basements common in Vienna estates. We maintain enough equipment to handle multiple simultaneous Vienna projects without delays.`,
  },
  pricingSection: {
    headline: 'Water Damage Restoration Pricing for Vienna Homes',
    intro: 'Every water damage event is unique, and restoration costs depend on several factors specific to your Vienna property. We provide detailed written estimates after our initial assessment — no hidden fees, no surprises. Most homeowner insurance policies cover water damage restoration, and we work directly with your carrier to streamline the claims process.',
    factors: [
  ...
  finalCTA: {
    ...
    paragraph: 'Every minute counts when water is damaging your home. Our IICRC-certified technicians are standing by 24/7 with an average 45-minute response time to every Vienna neighborhood. We handle everything — extraction, drying, restoration, insurance coordination — so you can focus on your family. One call starts the process.',
  },
}
