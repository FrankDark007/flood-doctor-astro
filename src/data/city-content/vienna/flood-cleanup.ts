...
export const content: CityServiceContent = {
  ...
  localChallenges: [
    ...
    },
    {
      ...
      description: `Vienna's signature tree canopy includes mature oaks, maples, and tulip poplars whose root systems extend beneath home foundations. These roots can crack foundation walls and floor slabs over decades, creating water entry paths that are invisible until a flood event exploits them. Root-compromised foundations allow water to enter from directions and volumes that the original waterproofing never anticipated.`,
  ...
  equipmentSection: {
    ...
    equipment: [
      ...
      },
      {
        ...
        purpose: `Pulls up to 30 gallons of moisture per day from the air, driving structural drying in enclosed spaces. We deploy multiple units per floor to maintain optimal grain depression throughout the drying zone. These units are critical for drying Vienna's plaster walls, which release moisture slowly over days.`,
        brand: 'Dri-Eaz',
      },
      {
        name: 'Thermal Imaging Camera',
        purpose: `Detects temperature differentials that reveal hidden moisture behind walls, above ceilings, and beneath floors without any destructive investigation. In Vienna's lath-and-plaster construction, thermal imaging identifies wet lath cavities that moisture meters cannot reach from the surface. We use these cameras during initial assessment and daily monitoring.`,
        brand: 'FLIR',
      },
      {
      ...
      },
      {
        ...
        purpose: 'Specialty mat system that creates controlled vacuum pressure on hardwood floors, drawing trapped moisture upward through the wood without removing the floor. This system saves original hardwood in Vienna homes that would otherwise require full replacement, preserving both the material and the significant cost of refinishing.',
        brand: 'Dri-Eaz',
      },
      {
        name: 'Injectidry Wall Cavity Drying System',
        purpose: `Forces warm, dry air into wall cavities through small access points, drying lath, plaster, and insulation from the inside out. This is the only effective method for drying Vienna's plaster-over-lath wall construction without full demolition. The system uses flexible hoses and adjustable pressure to reach every cavity in the wall assembly.`,
        brand: 'Injectidry',
      },
      {
