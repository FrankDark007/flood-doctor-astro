...
export const content: CityServiceContent = {
  ...
  introSection: {
    headline: `Responsive Flood Cleanup for Vienna's Community-Oriented Business District`,
    paragraphs: [
...
Our commercial flood teams bring contamination assessment, industrial extraction, and structural drying capability scaled for Vienna's commercial properties. We coordinate work schedules around business operations, minimize visible disruption to customer-facing areas, and communicate clearly with business owners who are managing client relationships alongside restoration decisions.`,
    ...
    localContext: `Vienna's community-oriented commercial districts along Church Street, Maple Avenue, and Oakton face flood risks from summer storms, aging infrastructure, and development-altered drainage—requiring cleanup crews who combine industrial capability with sensitivity to the business community's quality expectations.`,
  },
  processSteps: [
    {
    ...
    },
    {
      ...
      description: 'We identify the flood source and classify contamination level. Storm water entering from Maple Avenue or parking areas typically carries contaminants requiring elevated safety protocols compared to internal plumbing failures.',
    ...
    },
    {
      ...
      description: 'Flood-damaged materials are removed per safety protocols. Inventory is documented for insurance before disposal. Quality finishes salvageable through proper treatment receive preservation protocols rather than default demolition.',
    ...
    {
      title: 'Clearance & Reopening Coordination',
      description: 'Environmental testing where required confirms safe conditions. We coordinate reopening timing with business owners, helping plan customer communication and phased return to normal operations.',
      timeframe: 'Days 4-7',
    },
  ],
  localChallenges: [
    ...
    },
    {
      ...
      description: `Church Street's connected commercial buildings allow water from a pipe failure in one business to migrate through shared walls into adjacent spaces. A single plumbing event can affect three or four businesses, each with different insurance carriers and operational urgency.`,
      solution: `We trace water migration through shared walls using thermal imaging and manage the multi-business event as a coordinated project. Individual documentation supports each business's insurance claim while coordinated restoration prevents one tenant's work from disrupting adjacent businesses.`,
    },
    {
    ...
    },
    {
      ...
      description: 'Construction activity near Vienna Metro and Tysons Woods has altered established drainage patterns, creating new flood exposure for commercial properties that historically had no water problems. Business owners face unexpected flooding from changed surface water flow.',
      solution: 'We address the immediate flood damage while documenting the changed drainage conditions. Our assessment helps business owners and property managers identify the development-related cause for both insurance purposes and communication with local authorities about drainage infrastructure.',
    },
  ],
  equipmentSection: {
    headline: 'Flood Cleanup Equipment for Vienna Commercial Properties',
    equipment: [
      {
      ...
      {
        name: 'Contamination Classification Equipment',
        purpose: 'On-site water testing to determine safety protocols for storm flooding versus clean-water pipe failures',
      },
      {
        name: 'Quality Finish Preservation Tools',
        purpose: 'Specialized extraction and drying equipment that protects hardwood, millwork, and specialty materials from secondary damage',
      },
      {
        name: 'Antimicrobial Treatment Systems',
        purpose: 'EPA-registered treatments for commercial surfaces exposed to contaminated storm flooding',
      },
      {
  ...
  pricingSection: {
    ...
    intro: 'Vienna commercial flood cleanup costs depend on flood volume, contamination level, and the quality of finishes requiring preservation or replacement. We provide clear estimates before work begins and handle insurance claims directly with your carrier. Our pricing reflects honest assessment of what the work actually requires.',
    factors: [
  ...
  serviceAreaSection: {
    neighborhoods: [
      ...
      'Vienna Metro Area',
      'Wolf Trap Area',
      'Courthouse Road Commercial Area',
      'Park Street',
      'Cedar Lane Area',
    ],
  ...
  faqs: [
    {
      question: 'Can you respond during an active storm to prevent more flood damage?',
      answer: 'Yes. Our crews can begin extraction while storms are still active, positioning equipment to remove water as fast as it enters. For Vienna businesses with priority response agreements, we deploy at the first severe weather alert affecting your area.',
    },
    {
      question: 'How do you minimize disruption to our Church Street customers?',
      answer: 'We stage equipment using rear entrances, schedule noisy work during closed hours, and maintain customer-facing areas as presentable as possible throughout restoration. Our goal is to minimize visible evidence of flood work during your business hours.',
    },
    {
    ...
    },
    {
      ...
      answer: `Call us immediately. We'll assess your space, document the damage from the adjacent property's failure, and help you file a claim against your insurance or the neighboring property's carrier. Our thermal imaging traces the exact water path through shared walls.`,
    },
    {
      question: 'Do you provide flood prevention recommendations?',
      answer: `Yes. After cleanup, we assess your property's flood vulnerabilities and recommend prevention measures—improved drainage, flood barriers for vulnerable entries, water detection alarms, and plumbing upgrades for aging systems.`,
    },
    {
  ...
  finalCTA: {
    headline: 'Commercial Flood Emergency in Vienna?',
    paragraph: 'Your Vienna business customers and community are counting on you. Our flood cleanup crews respond fast, work discreetly, and restore your commercial space to the quality standard your business demands.',
  },
}
