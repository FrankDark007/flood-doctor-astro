...
export const content: CityServiceContent = {
  ...
  processSteps: [
    ...
    },
    {
      ...
      description: `Contaminated materials are removed under containment. Structural surfaces receive HEPA vacuuming and antimicrobial treatment. When mold has entered HVAC systems, we clean ductwork, coils, and air handlers. For Vienna's older commercial buildings, we adapt techniques to preserve original building elements where possible.`,
      timeframe: `Days 4-8`,
    },
    {
    ...
    },
    {
      ...
      description: `We trace every moisture pathway—aging plumbing, window condensation, roof issues, or HVAC problems—and coordinate with qualified contractors to resolve the source. For Vienna's older commercial buildings, this often involves modernizing plumbing or ventilation while maintaining building character.`,
      timeframe: `Days 10-14`,
    },
  ],
  localChallenges: [
    {
      title: `Condensation in Aging Church Street Buildings`,
      description: `Vienna Town's commercial buildings along Church Street feature original single-pane windows, minimal insulation, and vintage HVAC systems. Temperature differentials create condensation on interior surfaces and within wall cavities, sustaining mold growth that conventional cleaning cannot resolve.`,
      solution: `We remediate existing mold and address condensation through improved ventilation, supplemental dehumidification, and recommendations for building envelope upgrades that maintain Vienna's architectural character while eliminating chronic moisture.`,
    },
    {
      title: `Hidden Plumbing Leaks in Mixed-Age Buildings`,
      description: `Commercial properties throughout Vienna contain plumbing from multiple renovation eras—original copper mixed with PVC additions, aging supply lines behind finished walls, and drain connections that have shifted with foundation settling. Slow leaks feed mold colonies that grow undetected for months.`,
    ...
    },
    {
      ...
      description: `Commercial properties in wooded areas near Wolf Trap experience ambient humidity levels that overwhelm standard HVAC dehumidification, particularly during summer months. Persistent high humidity supports mold growth in wall cavities and above ceiling tiles throughout the cooling season.`,
      solution: `We install supplemental commercial dehumidification systems calibrated for the microclimate. Combined with improved ventilation and moisture barriers, these systems maintain indoor conditions below mold-growth thresholds year-round.`,
    },
  ],
  equipmentSection: {
    headline: `Mold Remediation Equipment for Vienna Commercial Properties`,
    equipment: [
      {
        name: `HEPA Air Scrubbers`,
        purpose: `Capture airborne spores within containment zones during remediation, protecting adjacent occupied Vienna commercial spaces`,
        brand: `Phoenix`,
      },
      {
        name: `Negative Air Machines`,
        purpose: `Maintain containment integrity in shared-wall commercial buildings along Church Street and Maple Avenue during active mold removal`,
      },
      {
        name: `Infrared Moisture Detection`,
        purpose: `Identify hidden moisture sources behind walls and above ceilings in Vienna's mixed-age commercial buildings without destructive investigation`,
        brand: `FLIR`,
      },
      {
        name: `Commercial Dehumidifiers`,
        purpose: `Maintain remediation-zone humidity and provide long-term moisture management for Vienna commercial spaces with chronic humidity challenges`,
        brand: `Dri-Eaz`,
      },
      {
      ...
      },
      {
        ...
        purpose: `Quantify moisture levels in building materials to trace water intrusion pathways in Vienna's older and newer commercial buildings`,
        brand: `Tramex`,
      },
    ],
  ...
  serviceAreaSection: {
    ...
    responseTime: `Same-day initial assessment for Vienna commercial mold concerns. CIH protocols begin within 48-72 hours. Emergency containment available within hours for active water events contributing to mold growth in occupied spaces.`,
  },
  faqs: [
    {
      question: `Why do older Vienna commercial buildings have more mold problems?`,
      answer: `1950s-70s commercial buildings feature single-pane windows, minimal insulation, and vintage HVAC systems that create condensation and moisture pathways. These age-related vulnerabilities sustain mold growth that modern buildings avoid through better building envelope design and ventilation.`,
    },
    {
      question: `Can our Church Street shop stay open during mold remediation?`,
    ...
    },
    {
      ...
      answer: `Recurrence means the moisture source was not fully resolved. Our remediation includes identifying and documenting every moisture pathway. We coordinate with contractors to fix the source and recommend ongoing humidity monitoring to catch any new moisture issues early.`,
    },
    {
      question: `Does our commercial policy cover mold remediation?`,
      answer: `Many policies exclude or limit mold, but mold from a covered water event—burst pipe, roof leak, HVAC condensate failure—has better coverage potential. We document the causal connection between the water source and mold growth to support your claim.`,
    },
    {
