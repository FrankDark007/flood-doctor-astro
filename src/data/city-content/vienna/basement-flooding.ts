    ...
    equipment: [
      {
        ...
        purpose: 'Removes thousands of gallons per hour from flooded basements through continuous vacuum extraction. Truck-mounted units generate far more suction than portable extractors, pulling water from carpet fibers, concrete pores, and hard-to-reach basement areas.',
        brand: 'Prochem',
      },
      {
        name: 'Submersible Sump Pumps',
        purpose: 'Handle deep standing water in severely flooded basements. Deployed when water depth exceeds what extraction wands can reach—common in full-basement flooding after sump pump failure. Pump continuously until water level drops enough for extraction equipment.',
        brand: 'Wayne',
      },
      {
        name: 'LGR Dehumidifiers',
        purpose: `Low-grain refrigerant dehumidifiers extract moisture from saturated basement air more efficiently than conventional units. Essential for drying concrete slab floors and block walls in Vienna's older homes where moisture loads are extremely high after flooding.`,
        brand: 'Dri-Eaz',
      },
      {
        name: 'High-Velocity Air Movers',
        purpose: 'Create focused airflow across basement floors, walls, and into cavities to accelerate evaporation. Positioned strategically based on basement layout—Vienna colonial basements typically require 15–25 units for adequate coverage.',
        brand: 'Dri-Eaz',
      },
      {
        name: 'Thermal Imaging Cameras',
        purpose: 'Detect hidden moisture behind walls, under flooring, and in ceiling cavities without destructive testing. Identifies wet areas that visual inspection and standard moisture meters miss—critical in finished basements where water travels behind drywall.',
        brand: 'FLIR',
      },
      {
        name: 'Pin & Pinless Moisture Meters',
        purpose: 'Measure exact moisture content in concrete, drywall, wood framing, and subfloor materials. Daily readings verify drying progress and confirm when materials reach safe moisture levels before reconstruction begins.',
        brand: 'Delmhorst',
      },
      {
        name: 'HEPA Air Scrubbers',
        purpose: 'Filter airborne mold spores, dust, and particulates during demolition and drying. Maintain air quality throughout the basement during restoration—especially important when removing water-damaged drywall and insulation that may harbor mold growth.',
        brand: 'Abatement Technologies',
      },
      {
        name: 'Injection Drying Systems',
        purpose: `Force warm, dry air into wall cavities, under floating floors, and behind built-in cabinetry. Essential for drying finished Vienna basements where removing all materials isn't necessary but trapped moisture behind surfaces must be eliminated.`,
        brand: 'Injectidry',
      },
    ],
    localNote: 'Our Vienna trucks carry equipment sized for typical 800–1,400 square foot basement footprints found in area colonials. We arrive with sufficient capacity to handle your entire basement on the first trip—no waiting for additional equipment while water continues damaging your home.',
  },
  pricingSection: {
    headline: 'Basement Flooding Restoration Costs in Vienna',
    intro: 'Basement flooding costs in Vienna vary significantly based on the scope of damage. A minor sump pump overflow caught within hours may cost $2,000–$4,000 to extract and dry. A finished basement with 12 inches of standing water requiring demolition, full structural drying, mold prevention, and reconstruction can reach $15,000–$30,000 or more. Most sudden flooding events are covered by homeowners insurance. We work directly with your insurance company, provide detailed documentation supporting your claim, and bill insurance directly when possible. Free on-site assessment before any work begins.',
    factors: [
